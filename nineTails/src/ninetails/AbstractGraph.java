...
public abstract class AbstractGraph<V> implements Graph<V> {
  protected List<V> vertices = new ArrayList<>(); // Vertices in the graph
  protected List<List<Edge>> neighbors = new ArrayList<>(); // Neighbors for each vertex in the graph 
  ...
  */
    ...
    @Override
    public boolean addEdge(ninetails.Edge e) {
